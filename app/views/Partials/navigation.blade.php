<div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            <a href="../" class="navbar-brand">Laravel Test App</a>
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes">Events <span class="caret"></span></a>
                    <ul class="dropdown-menu" aria-labelledby="themes">
                        <li><a tabindex="-1" href="/addEvent">Create Event</a></li>
                        <li class="divider"></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="http://builtwithbootstrap.com/" target="_blank">Don't have an account? Signup Now!</a></li>
                <li><a href="https://wrapbootstrap.com/?ref=bsw" target="_blank">Already have an account? Login</a></li>
            </ul>
